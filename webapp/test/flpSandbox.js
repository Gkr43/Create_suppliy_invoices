		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create Supplementary Invoices",
									"targetURL": "#createsuppleinvoice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"createsuppleinvoice-display": {
								"semanticObject": "createsuppleinvoice",
								"action": "display",
								"description": "Create Supplementary Invoices",
								"title": "Create Supplementary Invoices",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=createsuppleinvoice",
									"url": sap.ui.require.toUrl("createsuppleinvoice")
								}
							}
						}
					}
